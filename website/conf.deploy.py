...
BLOG_AUTHOR = "Wodka"  # (translatable)
BLOG_TITLE = "Pokémon Violet"  # (translatable)
...
# cache/whatever/thing.html (and maybe cache/whatever/thing.es.html)
#
